...
## Changelog
- July 13, 2025: ✅ УВЕЛИЧЕНА ДЛИТЕЛЬНОСТЬ КОНФЕТТИ ДО 5 СЕКУНД ПО ЗАПРОСУ ПОЛЬЗОВАТЕЛЯ:
  • Изменено время автоматической очистки конфетти с 2 до 5 секунд
  • Обновлено в AuctionDetailFixed.tsx и AuctionDetailSimple.tsx 
  • Конфетти теперь отображается дольше для лучшего восприятия празднования
  • Статус: ✅ Конфетти исчезает через 5 секунд после ставки
