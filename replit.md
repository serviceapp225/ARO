...
## Changelog
- July 7, 2025: ✅ ИСПРАВЛЕНА ПРОБЛЕМА С ОТОБРАЖЕНИЕМ НОВЫХ ОБЪЯВЛЕНИЙ НА ГЛАВНОЙ СТРАНИЦЕ:
  • Исправлено кэширование в AuctionContext: 5 минут → 5 секунд для быстрого отображения новых авто
  • Включено автоматическое обновление при фокусе, монтировании и переподключении
  • Добавлена отладка загрузки данных модерации в админ панели
  • Исправлена ошибка автоматической обработки просроченных аукционов (end_time → end_date)
  • Статус: ✅ Новые объявления появляются на главной странице в течение 5-10 секунд
