...
## Changelog
- July 27, 2025: ⚠️ ДИАГНОСТИКА ПРОБЛЕМЫ SMS API - НЕПРАВИЛЬНЫЙ АЛГОРИТМ ХЕШИРОВАНИЯ:
  • **VPS ПРОКСИ РАБОТАЕТ**: Сервер v4 успешно развернут на 188.166.61.86:3000 с исправленным кодом
  • **IP В БЕЛОМ СПИСКЕ**: Подтверждено - запросы проходят до OSON SMS API v1
  • **АРХИТЕКТУРА ФУНКЦИОНАЛЬНА**: Replit → VPS (188.166.61.86) → OSON SMS API v1 ✅
  • **ПРОБЛЕМА ВЫЯВЛЕНА**: OSON SMS возвращает error code 106 "Incorrect hash"
  • **ПАРАМЕТРЫ КОРРЕКТНЫ**: login=zarex, sender=OsonSMS, phone_number правильно обработан
  • **ТЕКУЩИЙ ХЕШ**: 8ac95b524e5cca4a115c691e31f6726068f77881d9f7ba4075392b755a152d56 (SHA-256)
  • **ТРЕБУЕТСЯ**: Правильный алгоритм хеширования от технической поддержки OSON SMS
  • **АЛЬТЕРНАТИВЫ**: Попробовать MD5, SHA-1, или специфическую последовательность хеширования
  • Статус: ⚠️ 98% ГОТОВО - VPS прокси функционален, нужен правильный алгоритм str_hash
