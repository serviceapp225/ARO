...
## Changelog
- July 16, 2025: ✅ SMS API УСПЕШНО ИНТЕГРИРОВАН С НОВЫМ ФОРМАТОМ OSON SMS:
  ...
  • РЕШЕНО: IP адрес 34.93.213.223 добавлен в белый список OSON SMS
  • Система автоматически переходит в демо-режим при недоступности API
  • ПРОТЕСТИРОВАНО: SMS код 482786 успешно доставлен на +992903331332
  • Статус: ✅ SMS интеграция полностью работает с новым API OSON SMS
