...
### Нерешенные проблемы SQLite
- Нужно доработать полную реализацию всех методов IStorage
- Исправить типы данных для SellCarSection и AdvertisementCarousel
- Добавить полную поддержку ставок, избранного, уведомлений
