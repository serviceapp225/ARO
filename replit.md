...
## Changelog
- July 14, 2025: ✅ ДОБАВЛЕН ОТСТУП ОТ НАВИГАЦИОННОЙ ПАНЕЛИ НА СТРАНИЦЕ СООБЩЕНИЙ:
  • Добавлен класс pb-24 к основному контейнеру страницы Messages.tsx
  • Обеспечен комфортный отступ от нижней навигационной панели
  • Исправлено для всех состояний: загрузка переписок, нет переписок, основной интерфейс
  • Устранена проблема с перекрытием содержимого навигационными кнопками
  • Статус: ✅ Страница сообщений теперь имеет правильные отступы от навигации
