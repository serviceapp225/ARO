...
## Changelog
- July 6, 2025: ✅ ИСПРАВЛЕНО МОРГАНИЕ ПРИЛОЖЕНИЯ ПРИ REAL-TIME ОБНОВЛЕНИЯХ:
  • Добавлен дебаунс обновления кэша (300мс) для предотвращения моргания
  • Немедленное обновление состояния (цена + поле ставки) без перерисовки
  • Убрано агрессивное очищение кэша, заменено на мягкое обновление
  • WebSocket сообщения обновляют интерфейс плавно без "моргания"
  • Статус: ✅ Ставки обновляются мгновенно и плавно без моргания экрана
