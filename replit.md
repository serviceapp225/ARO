...
- July 6, 2025: ✅ ИСПРАВЛЕНА СИСТЕМА УВЕДОМЛЕНИЙ ПРИ ЛИДЕРСТВЕ В СТАВКАХ:
  • Убраны звуки и конфетти при повторных ставках когда пользователь уже лидирует
  • При лидерстве показывается тихое уведомление "Вы лидируете" без эффектов
  • При обычных ставках показывается "Ставка принята" с полными эффектами
  • Логика проверяет текущий статус лидерства пользователя перед показом эффектов
  • Статус: ✅ Повторные ставки лидирующего пользователя тихие, новые ставки с эффектами
