...
## Changelog
- July 14, 2025: ✅ СБАЛАНСИРОВАННАЯ ОПТИМИЗАЦИЯ СКОРОСТИ ОТКРЫТИЯ СТРАНИЦ АУКЦИОНОВ:
  • Добавлена debounced предзагрузка данных при наведении на карточку аукциона (300мс задержка)
  • Предзагружаются данные аукциона и ставки в фоновом режиме только при длительном наведении
  • Оптимизированы настройки кэширования в AuctionContext: staleTime 2 секунды, gcTime 30 секунд
  • Улучшена система предзагрузки данных при клике на карточку (handleCardClick)
  • Исправлена проблема медленной загрузки главной страницы из-за чрезмерно агрессивного кэширования
  • Результат: быстрое открытие страниц аукционов без замедления первоначальной загрузки
  • Статус: ✅ Найден баланс между скоростью детальных страниц и первоначальной загрузкой
