...
## Changelog
- July 27, 2025: ✅ КРИТИЧЕСКОЕ ИСПРАВЛЕНИЕ SMS API - НЕПРАВИЛЬНЫЙ АЛГОРИТМ ХЕШИРОВАНИЯ:
  • **ПРОБЛЕМА ВЫЯВЛЕНА**: IP 188.166.61.86 добавлен в белый список, но возвращается ошибка "Incorrect hash"
  • VPS сервер v3 создан с исправленным POST методом (вместо GET)
  • Параметры передаются корректно: from, phone_number, msg, str_hash, txn_id, login
  • Архитектура работает: Replit → VPS (188.166.61.86) → OSON SMS API v1
  • **ТЕКУЩАЯ ПРОБЛЕМА**: Неправильный алгоритм вычисления str_hash
  • Использованный хеш: 8ac95b524e5cca4a115c691e31f6726068f77881d9f7ba4075392b755a152d56
  • OSON SMS API требует специфический алгоритм хеширования
  • **РЕШЕНИЕ**: Нужна техническая документация от OSON SMS с правильным алгоритмом хеша
  • Статус: ⚠️ 95% ГОТОВО - требуется правильный алгоритм str_hash от поставщика SMS
