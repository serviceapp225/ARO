...
## Changelog
- July 6, 2025: ✅ ИСПРАВЛЕНА ЗАДЕРЖКА ОБНОВЛЕНИЯ СТАВОК В REAL-TIME:
  • WebSocket получает сообщения мгновенно, но кэш блокировал обновления
  • Добавлено экстренное очищение кэша при получении WebSocket сообщения bid_update
  • Ускорено обновление ставок: каждые 3 секунды + мгновенное обновление через WebSocket
  • Настройки кэша для ставок: staleTime 1 сек, gcTime 5 сек для real-time обновлений
  • Немедленное обновление цены и поля ставки при получении WebSocket события
  • Статус: ✅ Ставки теперь обновляются мгновенно через WebSocket + backup каждые 3 сек
