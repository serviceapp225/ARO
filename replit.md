...
## Changelog
- July 13, 2025: ✅ ПЕРСОНАЛИЗАЦИЯ СООБЩЕНИЙ УВЕДОМЛЕНИЙ О ПЕРЕБИТЫХ СТАВКАХ:
  • Изменен текст уведомлений с подробного на краткий: "ваша ставка перебита"
  • Обновлено в двух местах: server/websocket.ts и server/routes.ts
  • Убрана лишняя информация о сумме ставки и деталях аукциона
  • Сделан акцент на личностное обращение к пользователю
  • Статус: ✅ Уведомления теперь более лаконичные и персонализированные
