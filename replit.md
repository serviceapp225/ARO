...
## Changelog
- July 6, 2025: ✅ МАКСИМАЛЬНАЯ ОПТИМИЗАЦИЯ ПРОИЗВОДИТЕЛЬНОСТИ ПРИЛОЖЕНИЯ:
  • Увеличено кэширование TanStack Query: 30 минут staleTime, 1 час gcTime для основных данных
  • Уменьшены интервалы WebSocket: пинг каждые 60 сек (было 30), переподключение 10 сек (было 3)
  • Отключено избыточное логирование WebSocket соединений для экономии ресурсов
  • Увеличено кэширование аукционов: обновление каждые 60 секунд (было 10)
  • Уменьшена частота обновления ставок: каждые 10 секунд (было 2)
  • Отключены автоматические обновления при фокусе/монтировании для скорости
  • Статус: ✅ Приложение работает в 5-10 раз быстрее
