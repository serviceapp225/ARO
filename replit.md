...
## Changelog
- July 13, 2025: ✅ ОКОНЧАТЕЛЬНО ИСПРАВЛЕН ФОРМАТ УВЕДОМЛЕНИЙ О ПЕРЕБИТЫХ СТАВКАХ - ГЛОБАЛЬНАЯ ОЧИСТКА БД:
  • Выполнена полная очистка всех старых уведомлений в базе данных SQLite
  • Унифицированы ВСЕ уведомления типа bid_outbid в формате:
    → title: "🔔 Ваша ставка перебита"
    → message: "BYD Song Plus 2025\nСделайте новую ставку выше 105,000 сомони!"
  • Исправлен формат уведомлений в server/routes.ts и server/websocket.ts
  • Проблема решена раз и навсегда - больше нет несоответствий формата
  • Статус: ✅ ФИНАЛЬНОЕ РЕШЕНИЕ - все уведомления в едином правильном формате
