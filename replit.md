...
## Changelog
- July 13, 2025: ✅ ИСПРАВЛЕН ФОРМАТ УВЕДОМЛЕНИЙ О ПЕРЕБИТЫХ СТАВКАХ - ТОЧНОЕ СООТВЕТСТВИЕ ТРЕБОВАНИЯМ:
  • Исправлен формат уведомлений в server/routes.ts (строка 899): title "🔔 Ваша ставка перебита" + message с переносом строки
  • Исправлен формат уведомлений в server/websocket.ts (строки 344 и 356): единый формат для WebSocket и базы данных
  • Теперь уведомления отображаются в правильном формате: заголовок с эмодзи + название авто + призыв к действию
  • Устранена проблема со старым форматом где всё было в одной строке с эмодзи посередине
  • Статус: ✅ Все уведомления теперь соответствуют требуемому формату
