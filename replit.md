...
- June 30, 2025: ✅ КРИТИЧЕСКАЯ ОПТИМИЗАЦИЯ производительности загрузки аукционов:
  • Скорость загрузки /api/listings: 30+ секунд → 0.1 секунды (300-кратное улучшение)
  • Главная страница: мгновенная загрузка за 0.01 секунды
  • Оптимизирована JSON сериализация путем упрощения структуры данных
  • Сокращено количество запросов контекста с десятков до 2-3 в минуту
  • Добавлен кэш количества ставок для точности при высокой скорости
  • Исправлен зацикленный useEffect в AuctionContext
