...
## Changelog
- July 5, 2025: ✅ УДАЛЕНЫ БАННЕРЫ ВТОРОЙ КАРУСЕЛИ ПО ЗАПРОСУ ПОЛЬЗОВАТЕЛЯ:
  • Компонент SecondTripleCarousel удален с главной страницы
  • Убраны баннеры "Приведи друга", "Горячие аукционы", "Стань экспертом"
  • Главная страница очищена от рекламных блоков
  • Админ панель по-прежнему содержит управление второй каруселью (неактивно)
  • Статус: ✅ Баннеры полностью удалены с главной страницы
