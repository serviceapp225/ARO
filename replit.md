...
- July 6, 2025: ✅ ВОССТАНОВЛЕНЫ ЭФФЕКТЫ ПРИ СТАВКАХ:
  • Возвращены звуки и конфетти для всех ставок пользователей
  • Единое уведомление "Ставка принята" для всех успешных ставок
  • Эффекты показываются при каждой ставке независимо от статуса лидерства
  • Статус: ✅ Все ставки снова сопровождаются полными эффектами
