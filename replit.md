...
## Changelog
- July 14, 2025: ✅ КРИТИЧЕСКАЯ ОПТИМИЗАЦИЯ СКОРОСТИ ОТКРЫТИЯ СТРАНИЦ АУКЦИОНОВ:
  • Добавлена предзагрузка данных при наведении на карточку аукциона (handleCardHover)
  • Предзагружаются данные аукциона и ставки в фоновом режиме при onMouseEnter
  • Оптимизированы настройки кэширования в AuctionContext: staleTime 5 секунд, gcTime 60 секунд
  • Улучшена система предзагрузки данных при клике на карточку (handleCardClick)
  • Результат: мгновенное открытие страницы аукциона при клике благодаря предзагрузке данных
  • Статус: ✅ Страницы аукционов теперь открываются практически мгновенно
