...
- July 6, 2025: ✅ ИСПРАВЛЕНА СИСТЕМА УВЕДОМЛЕНИЙ ПРИ ЛИДЕРСТВЕ В СТАВКАХ:
  • Убраны звуки и конфетти при ставках когда пользователь лидирует
  • При лидерстве показывается тихое уведомление "Вы лидируете"
  • При обычных ставках показывается "Ставка принята"
  • Логика проверяет будет ли пользователь лидировать после ставки
  • Статус: ✅ Повторные ставки лидирующего пользователя без эффектов
