              ...
              <div className="prose prose-gray max-w-none">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Настоящая Политика конфиденциальности регулирует порядок сбора, использования и защиты персональных данных пользователей сайта AutoBid TJ (далее — «Сайт»). Мы уважаем ваше право на конфиденциальность и стремимся обеспечить безопасность вашей информации.
                  </p>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    <strong>1.2.</strong> Оператором персональных данных является владелец Сайта — AutoBid TJ, далее — «Оператор».
                  </p>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-700">
                      По вопросам обработки персональных данных и защиты конфиденциальности обращайтесь к администрации сайта AutoBid TJ.
                    </p>
                  </div>
                </div>
