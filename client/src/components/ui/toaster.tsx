  ...
  return (
    <ToastProvider>
      {toasts.map(function ({ id, title, description, action, ...props }) {
        ...
        // Принудительно закрываем уведомления о поисковых запросах и ошибке копирования через 1 секунду
        const forceAutoClose = title === "Поисковый запрос удален" || title === "Поисковый запрос сохранён" || title === "Ошибка"
